...
public class BlockEntityListener {
    ...
    public void registerBlockEntities(BlockEntityRegisterEvent event) {
        ...
        event.register(ProjectE.NAMESPACE.id("interdiction_torch"), InterdictionTorchBlockEntity.class);

        event.register(ProjectE.NAMESPACE.id("dark_matter_pedestal"), DarkMatterPedestalBlockEntity.class);
    }
}
