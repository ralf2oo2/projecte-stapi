...
public interface ItemEmc
{
     ...
     */
    long addEmc(@NotNull ItemStack stack, long toAdd);
     ...
     */
    @Deprecated
    default double addEmc(@NotNull ItemStack stack, double toAdd) {
     ...
     */
    long extractEmc(@NotNull ItemStack stack, long toRemove);
     ...
     */
    @Deprecated
    default double extractEmc(@NotNull ItemStack stack, double toRemove) {
