package net.ralf2oo2.projecte.api.registry;
...
public interface ConversionRegistry {
     ...
     *     <li>{@link FluidStack} - {@link FluidStack#fluid} and {@link Fluid#getIdentifier()} will be used to identify this Fluid.</li>
     *     <li>{@link String} - will be interpreted as an tag name.</li>
     ...
     * @param ingredients
     */
    void addConversion(@NotNull Namespace namespace, int amount, @NotNull Object output, @NotNull Map<Object, Integer> ingredients);
}
