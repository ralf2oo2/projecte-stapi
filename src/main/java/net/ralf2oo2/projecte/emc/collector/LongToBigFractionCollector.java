...
public class LongToBigFractionCollector<T, A extends ValueArithmetic> extends AbstractMappingCollector<T, Long, A>
{
    private final ExtendedMappingCollector<T, BigFraction, A> inner;

    public LongToBigFractionCollector(ExtendedMappingCollector<T, BigFraction, A> inner) {
