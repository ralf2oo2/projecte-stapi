 ...
 */
public interface MappingCollector<T, V extends Comparable<V>> {
    /**
     ...
     * {@code value} has to be >= 0 or {@link ValueArithmetic#isFree(Comparable) Free}, which indicates that {@code something} can be used in
     ...
     * @param value The value. >= 0 or {@link ValueArithmetic#isFree(Comparable)}{@code == true}
     */
